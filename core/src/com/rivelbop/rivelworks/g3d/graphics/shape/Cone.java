...
public class Cone extends Shape3D {
    ...
    /**
     * Creates a cone by providing a model instance and dimensions.
     *
    ...
    /**
     * Creates a cone by providing a model and dimensions.
     *
     ...
     * @param divisions The amount of divisions the cone will have.
     */
    public Cone(Model model, float radius, float height, int divisions) {
        super(model);
