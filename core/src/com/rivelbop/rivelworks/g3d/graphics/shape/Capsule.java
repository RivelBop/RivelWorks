...
public class Capsule extends Shape3D {
    ...
    /**
     * Creates a capsule by providing a model instance and dimensions.
     *
     ...
     * @param divisions     The amount of divisions the capsule will have.
     */
    public Capsule(ModelInstance modelInstance, float radius, float height, int divisions) {
        this(modelInstance.model, radius, height, divisions);
    }

    /**
     * Creates a capsule by providing a model and dimensions.
     *
     ...
     * @param divisions The amount of divisions the capsule will have.
     */
    public Capsule(Model model, float radius, float height, int divisions) {
        super(model);
