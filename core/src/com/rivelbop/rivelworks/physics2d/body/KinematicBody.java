...
/**
 * An extension of {@link PhysicsBody}, used to create kinematic bodies.
 *
...
public class KinematicBody extends PhysicsBody {
     ...
     */
    public KinematicBody(World world, Shape aShape, float density, float friction, float bounciness) {
