...
/**
 * An extension of {@link PhysicsBody2D}, used to create dynamic bodies.
 *
 * @author Philip Jerzak (RivelBop)
 */
public class DynamicBody2D extends PhysicsBody2D {
    /**
     ...
     */
    public DynamicBody2D(World world, Shape aShape, float density, float friction, float bounciness) {
