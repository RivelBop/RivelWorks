...
/**
 * An extension of {@link PhysicsBody2D}, used to create kinematic bodies.
 *
 * @author Philip Jerzak (RivelBop)
 */
public class KinematicBody2D extends PhysicsBody2D {
    /**
     * Create a kinematic body by providing the world to add the body to, the body shape, and properties of the body.
     *
     ...
     */
    public KinematicBody2D(World world, Shape aShape, float density, float friction, float bounciness) {
        super(world, BodyDef.BodyType.KinematicBody);
